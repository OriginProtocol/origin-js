...
module.exports = function() {
  ...
  files.forEach(file => {
    ...
    const { abi, bytecode, contractName, networks, ast, deployedBytecode } = JSON.parse(contractJSON)
    const simplifiedJSON = { abi, bytecode, contractName, networks, ast, deployedBytecode }
